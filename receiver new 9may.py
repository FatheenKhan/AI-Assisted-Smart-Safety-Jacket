...
stored_audio = None
cred = credentials.Certificate(r"C:\Users\harin\PycharmProjects\voice assistant sample\.venv\Scripts\safetyjacket15-firebase-adminsdk-qv7da-f2a415427a.json")
...
def help():
    ...
    host = '192.168.1.4'  # Replace with the IP address of the receiver device (Device B)
